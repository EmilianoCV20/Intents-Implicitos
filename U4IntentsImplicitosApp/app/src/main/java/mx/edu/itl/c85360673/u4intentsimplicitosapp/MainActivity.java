...
public class MainActivity extends AppCompatActivity {
    ...
    public void  btnAbrirPaginaWebClick    ( View v ) {
        layout      = getLayoutInflater().inflate ( R.layout.layout_edit_text_simple, null );
        edtTexto  = layout.findViewById  ( R.id.edtTexto );
        edtTexto.setText ( "www.mangadex.org" );
        ...
        builder.setTitle ( "Texto a enviar:" )
                ...
                .setPositiveButton("Enviar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        intent.putExtra ( Intent.EXTRA_CC,    new String [] { "emilianocepeda@outlook.com"     } );
                        intent.putExtra ( Intent.EXTRA_SUBJECT, "Mensaje de correo de prueba"  );
    ...
    public void btnExploradorArchsClick    ( View v ) {
        ...
        try {
            ...
            startActivityForResult ( Intent.createChooser ( intent, "Seleccion de Opcion:" ),
